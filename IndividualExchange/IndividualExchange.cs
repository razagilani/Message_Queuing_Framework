...
namespace IndividualExchange
{
    public class IndividualExchange:Exchange
    {
        public IndividualExchange(Dictionary<string, List<Dictionary<string, string>>> config, string name, object obj, string handler_module)
