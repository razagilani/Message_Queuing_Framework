...
namespace Portal
{
    public sealed class ExchangeConfig : ConfigurationSection
    {
        #region Member Variables
        private static ExchangeConfig settings = ConfigurationManager.GetSection("RoutingKey") as ExchangeConfig;
        #endregion
        #region Fields
        /// <summary>
        /// Settings Property
        /// </summary>
        public static ExchangeConfig Settings
        {
            get { return settings; }
        }
